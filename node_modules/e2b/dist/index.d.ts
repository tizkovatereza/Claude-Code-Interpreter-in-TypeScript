...
export { APIClient, API_HOST, AuthenticationError, CurrentWorkingDirectoryDoesntExistError, DownloadFileFormat, EnvVars, FileInfo, FilesystemEvent, FilesystemEventListener, FilesystemManager, FilesystemOperation, FilesystemWatcher, OpenPort, Process, ProcessManager, ProcessMessage, ProcessOutput, RunningSandbox, SANDBOX_DOMAIN, Sandbox, SandboxMetadata, SandboxOpts, Terminal, TerminalManager, TerminalOutput, TimeoutError, components, Sandbox as default, paths, withAPIKey, withAccessToken };
